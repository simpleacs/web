...
<c:if test="${param.error != null}">
    ...
    <input type="text" name="j_username" id="j_username" class="form-control" value="user"
           placeholder="<fmt:message key="label.username"/>" required tabindex="1">
    <input type="password" class="form-control" name="j_password" id="j_password" tabindex="2" value="user"
