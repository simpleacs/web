...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see vnpt.technology.ssdc.service.impl.PasswordTokenManager#generateRecoveryToken(vnpt.technology.ssdc.model.User)
     */
    @Override
    ...
    /**
     * @see vnpt.technology.ssdc.service.impl.PasswordTokenManager#isRecoveryTokenValid(vnpt.technology.ssdc.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see vnpt.technology.ssdc.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
